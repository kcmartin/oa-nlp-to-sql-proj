...
if __name__ == "__main__":
    ...
    logging.info(f"Data Fomat: {df.shape}")
    ...
    logging.info(f"Fixed SQL Promp: {fixed_sql_prompt}")
    ...
    logging.info(f"Response obttained. Proposed sql query: {proposed_query_postprocessed}")
